...
![Annual tax revenue by settlement tier (typical domain, 278,484 koku/year)](tax_pie.svg)

A typical domain's 278,484 koku/year tax base, broken down by where it comes from. The single capital city contributes less than a third of what the 1,296 hamlets contribute in aggregate, despite each hamlet paying only ~69 koku/year - the long tail of small settlements outweighs the head.
