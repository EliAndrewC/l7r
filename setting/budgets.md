...
- **Tax Farming (discretionary cut)** is the office-holder's discretionary income at that tier.  The county magistrate's ~1,000 and the provincial governor's ~10,000 are tightly load-bearing canonical figures across the campaign.  The domain daimyo's ~40,000 typical figure is a rough median; actual daimyo cuts range from ~25,000 (poor frontier domains) to ~90,000+ (wealthy clan capitals), with structural factors like Hida-vassal status (~57,000 for the Reiji example documented above) creating additional variation.  **Note that this typical cut rose from an earlier ~30,000**: because the Empire pays the ~300 of each domain's working samurai who serve in Imperial posts (legions, cross-clan yoriki, central court), the daimyo's stipend outlay is ~10,000 lower than his in-domain headcount alone would imply, and that saving flows to his discretionary cut - the "hidden Imperial subsidy to the clans" documented in the [Imperial Legions](#imperial-legions-line-item-detail) section made concrete.  (The governor and magistrate cuts hold at their canonical 10,000 / 1,000; the provincial samurai savings pass up to the daimyo, who absorbs the full subsidy.)
