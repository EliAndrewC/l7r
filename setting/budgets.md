...
- **Tax Farming (discretionary cut)** is the office-holder's discretionary income at that tier.  The county magistrate's ~1,000 and the provincial governor's ~10,000 are tightly load-bearing canonical figures across the campaign.  The domain daimyo's ~40,000 typical figure is a rough median; actual daimyo cuts range from ~25,000 (poor frontier domains) to ~90,000+ (wealthy clan capitals), with structural factors like Hida-vassal status (~57,000 for the Reiji example documented above) creating additional variation.  **Note that this typical cut rose from an earlier ~30,000**: because the Empire pays the ~300 of each domain's working samurai who serve in Imperial posts (legions, cross-clan yoriki, central court), the daimyo's stipend outlay is ~11,000 lower than his in-domain headcount alone would imply, and that saving flows to his discretionary cut - the "hidden Imperial subsidy to the clans" documented in the [Imperial Legions](#imperial-legions-line-item-detail) section made concrete.  (The governor and magistrate cuts hold at their canonical 10,000 / 1,000; the provincial samurai savings pass up to the daimyo, who absorbs the full subsidy.)
...
- **Imperial Legions (~125) and remote road-waystation postings: almost never.**  These are hardship or fast-rotating postings; the samurai's family stays resident in Reiji.
...
- **Cross-clan IM-office and sub-station tours (~80): partial.**  Spouse and infants typically come; school-age children and retired parents usually remain in Reiji with the lineage.

Netting this out, **~60-70 non-working Reiji samurai accompany the ~300 abroad**, skewing strongly **young** - babies and toddlers travelling with their parents, plus some pregnant spouses (who may or may not draw a stipend, as this varies by locality with no Imperial decree on the matter).  **Retirees almost never leave**, since samurai retire at home among their lineage.  So ~360-370 Reiji samurai (working + non-working) are physically outside the domain at any moment - all still counted in Reiji's ~5,000 lineage allocation - while the other ~4,630 reside within Reiji's borders (a hair under 2% of its 250,000 inhabitants, the slight net-export dip that Otosan Uchi's 4% concentration and the Wall-massed legions balance out Empire-wide).
