...
Legend of the Five Rings is an RPG which began as a collectible card game, with the RPG spinoff originally published by Alderac Entertainment Group under license from Five Rings Publishing Group, the company that held the L5R property and was itself spun off from the Alderac and Isomedia partnership and which was later absorbed by Wizards of the Coast, which also bought TSR (the makers of Dungeons & Dragons) and is itself owned by Hasbro, which sold the rights to L5R back to Alderac, which later sold them to Fantasy Flight Games (by then part of Asmodee), which transferred the RPG to Asmodee's Edge Studio subsidiary.
...
Legend of the Five Rings and all associated names, characters, places, and settings are trademarks and/or copyrights of their owner (not me).  The original Legend of the Five Rings game and property were created and designed by John Wick and David Williams.

This work is distributed freely: no money is charged, and no one profits in any way from its creation or distribution.

This project meets Asmodee North America's [Guidelines for Community Use of Our Intellectual Property](https://images-cdn.fantasyflightgames.com/filer_public/51/c8/51c8035b-240e-4a12-8ab6-a7b34b97c819/ip_policy_2024_aug20.pdf).
